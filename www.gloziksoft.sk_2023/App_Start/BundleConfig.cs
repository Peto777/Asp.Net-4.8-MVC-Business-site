...
namespace www.gloziksoft.sk_2023
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            //            "~/Content/js/scroll.js"));

            //bundles.Add(new ScriptBundle("~/bundles/tawkto").Include(
            //            "~/Content/js/Dufeksoft.TawkTo.js"));

            //bundles.Add(new ScriptBundle("~/bundles/ga").Include(
            //            "~/Content/js/Dufeksoft.GoogleAnalytics-1.js"));

            //bundles.Add(new ScriptBundle("~/bundles/bootstrap").Include(
            //            "~/Content/js/bootstrap.jquery.js",
