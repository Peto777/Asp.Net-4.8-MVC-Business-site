...
using www.gloziksoft.sk_2023.AppLib.Mail;
using www.gloziksoft.sk_2023.AppLib.Template;
using www.gloziksoft.sk_2023.Models;
using www.gloziksoft.sk_2023.Models.Request;
...
namespace www.gloziksoft.sk_2023.Controllers
{
    public class HomeSkController : _PgsoftwebController
    {
        ...
        public ActionResult Web_BlogNews()
        {
            SetLanguageAction("Web_BlogNews");
            SetMenuCssClass("Web", "Web_BlogNews");
            return View();
        }
